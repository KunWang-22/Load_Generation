...
def train(args, device):
    ...
    diffusion = Diffusion(noise_step=args.noise_step, beta_start=args.beta_start, beta_end=args.beta.end, data_length=args.data_length, device=device)
...
if __name__ == "__main__":
    ...
    # Dataset 参数
    parser.add_argument("--file_path", dtype=str, default="../data/UKDA_2013_clean.csv")
    parser.add_argument("--aggregation_num", dtype=int, default=10)
    # Diffusion 参数
    parser.add_argument("--noise_step", dtype=int, default=50)
    parser.add_argument("--beta_start", dtype=float, default=0.0001)
    parser.add_argument("--beta_end", dtype=float, default=0.5)
    parser.add_argument("--data_length", dtype=int, default=48)
    # Model 参数
    parser.add_argument("--input_dim", dtype=int, default=1)
    parser.add_argument("--condition_input_dim", dtype=int, default=1)
    parser.add_argument("--embedding_dim", dtype=int, default=32)
    parser.add_argument("--num_head", dtype=int, default=4)
    parser.add_argument("--num_layer", dtype=int, default=4)
    parser.add_argument("--num_block", dtype=int, default=4)
    parser.add_argument("--dropout", dtype=float, default=0.2)
    
    parser.add_argument("--batch_size", dtype=int, default=16)
